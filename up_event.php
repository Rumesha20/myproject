...
move_uploaded_file($file_tmp,"upload/".$file_name);
	...
	$descri=$_POST['discr'];
	if(mysql_query("update event_details set ename='$eve_name',etype='$eve_type',eimages='$fpath' ,echarges=$eve_charge, description='$descri' where eid=$eve_id"))
	{
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div class="container">
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form method="POST" action="up_event.php" enctype="multipart/form-data">
			...
			<div class="form-row">
              ...
              <div class="form-label-group">
                <?php 
					...
					{
						echo "<option value='$rw[0]'>$rw[1]($rw[2])</option>";
					}
					echo "</select>";
				?>
              </div>
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="text" id="eventname" class="form-control" placeholder="Event Charges" required="required" name="ename">
                <label for="eventname">Event Provider name</label>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="text" id="disc" class="form-control" placeholder="Srvices provided" required="required" name="discr">
                <label for="disc">Services Provided</label>
              </div>
            </div>
